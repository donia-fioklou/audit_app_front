...
const AnnexeResultat = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/auditapp/chapitre-stats-actuel/detail/`)
    .then(response => response.json())
    .then(data => {
      console.log("data",data);
      setSousChapitres(data)
    })
    
  },[])
  console.log("setSousChapitres",setSousChapitres);
  return (
                  ...
                  <div id="kt_app_content" className="app-content">
                    ...
                    <div className="row gy-5 g-xl-10">
                      <div className="row g-5 g-xl-10 mb-5 mb-xl-0">
                        ...
                        {sousChapitres.map((sousChapitre,index)=>(<div className="col-md-6 mb-xl-10">
                          ...
                          <div className="card card-flush">
                            ...
                            <div className="card-body d-flex align-items-end">
                              ...
                              <div className="d-flex flex-column">
                                <RadarChart labels={sousChapitre.num_sous_chap} notes={sousChapitre.note_sous_chap}/>
                              </div>
                              {/*end::Wrapper*/}
                            </div>
                            {/*end::Card body*/}
